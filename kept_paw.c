...
void kept_paw()
{
    ...
    printf("You stare at it for a few seconds.\n");
    Sleep(1000);

    printf("Then you laugh.\n");
    Sleep(1000);

    printf("\"Okay. It's just a stupid monkey paw.\"\n");
    Sleep(1000);
    ...
    printf("This time, you notice something.\n");
    Sleep(1000);

    printf("There's writing on the palm.\n");
    Sleep(1000);
    ...
    printf("There's nothing on the other side.\n");
    Sleep(1000);

    printf("You look back at the palm.\n");
    Sleep(1000);

    printf("The writing is gone.\n");
    Sleep(1000);
    ...
    printf("2. Throw it in the fireplace.\n\n");
    Sleep(1000);
